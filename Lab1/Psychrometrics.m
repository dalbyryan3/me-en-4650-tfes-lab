...
%   Tdb, w; Tdb, phi; Tdb, h; w, phi; w, h; phi, h; Tdb, Twb; 
%   w, Twb; phi, Twb;  
%
% Example calculation for properties in Salt Lake City (~26 in Hg pressure)
%   [Tdb,w,phi,h,Tdp,v,Twb]=Psychrometrics('tdb',25,'h',44.5e3,'p',88);
%
% Following ASHRAE 2013 Fundamentals SI Psychrometrics chapter equations 
% are used: Eq6:Pws=f(Tdb); Eq22: w=f(Tdb, phi, p); Eq24: phi=f(Tdb, w, p);
% Eq28:v=f(Tdb, w and p); Eq32:h=f(Tdb, w and p); Eq35:Twb=f(Tdb,w); 
% Eq39:Tdp=f(Tdb, p);
